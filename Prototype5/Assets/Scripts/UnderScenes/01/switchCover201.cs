...
public class switchCover201 : MonoBehaviour {
	...
	void OnMouseUpAsButton(){
		...
		if (coverOpen) {
			...
			GameObject.Find ("01-cover-collider").GetComponent<switchCover01> ().coverOpen = true;
			...
			GameObject.Find ("01-cover-collider").GetComponent<switchCover01> ().coverOpen = false;
		}
	}
}

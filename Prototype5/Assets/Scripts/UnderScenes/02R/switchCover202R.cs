...
public class switchCover202R : MonoBehaviour {
	...
	void OnMouseUpAsButton(){
		...
		if (coverOpen) {
			...
			GameObject.Find ("02R-cover-collider").GetComponent<switchCover02R> ().coverOpen = true;
			...
			GameObject.Find ("02R-cover-collider").GetComponent<switchCover02R> ().coverOpen = false;
		}
	}
